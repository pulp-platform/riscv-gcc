...
(define_c_enum "unspec" [
  ...
  ;; It handlers return TODO: remove this, obsolete
  UNSPEC_ITU
  UNSPEC_ITS
  UNSPEC_ITH
  UNSPEC_ITM
...
;; PULP min/max/avg
(include "pulp-minmax.md")

;; PULP popcount/fl1/parity/rotate
(include "pulp-bitop2.md")

;; PULP mul/mac (optionally with norm round)
(include "pulp-mulmac.md")

;; PULP add/sub with rounding and norm
(include "pulp-addsubn.md")

;; PULP clip/clipu
(include "pulp-clip.md")

;; PULP bitop
(include "pulp-bitop.md")
...
;; PULP load store indirect
;; Reg - Reg load and store
(include "pulp-indregreg.md")

;; PULP misc instructions (and openmp for now)
(include "pulp-misc.md")

;; PULP postmod load/stores
(include "pulp-postmod.md")
...
;; pulp vector extensions
(include "pulp-vect.md")
...
(define_insn "*f<quiet_pattern>_quiet<ANYF:mode><X:mode>4_default"
  ...
  "(TARGET_HARD_FLOAT || TARGET_ZFINX || TARGET_ZDINX) && ! HONOR_SNANS (<ANYF:MODE>mode)"
